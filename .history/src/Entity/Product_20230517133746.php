...
class Product
{
    ...
    public function calcultatePriceWithPromotion(): ?string
    {
        $price = $this->getProductPrice();
        $promotion = $this->getPromotions();
        if($promotion->isEmpty()) return $price;
        else
        $priceWithPromotion = $price - ($price * $promotion->promotion_rate / 100);
