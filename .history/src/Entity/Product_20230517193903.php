...
class Product
{
    ...
    {   
       foreach($this->getPromotions() as $promotion){
           ...
           $promotionStart = $promotion->dateBetweenPromotion();
           $promotionEnd = $promotion->getPromotionEnd();
           $today = new \DateTime();
           if($today >= $promotionStart && $today <= $promotionEnd){
               $this->product_price = $this->product_price - ($this->product_price * $promotionRate / 100);
           }
