...
class Product
{
    ...
    {
        return  number_format($this->getCalculatePrice() ,2) ;
    }
    ...
    public function calculatePrice()
    {
        ...
        foreach ($this->promotions as $promotion) {
            if ($now >= $promotion->getPromotionStart() && $now <= $promotion->getPromotionEnd()) {
                // Produit en promotion
                return $this->getProductPrice() * (1 - ($promotion->getPromotionRate() / 100));
            }
        }
