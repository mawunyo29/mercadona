...
class Product
{
    ...
    {
        return  $this->promotions->count() > 0 ? $this->getDiscountedPrice($this->promotions->first()) : $this->product_price;
    }

    public function getDiscountedPrice(Promotion $promotion): ?string
    {
        if($this->promotions->contains($promotion)){
            $discountedPrice = $promotion->getPromotionPrice($this);
            
            $this->setProductPrice($discountedPrice);
